...
public class BaseSpinnerUI extends BasicSpinnerUI {
    /**
     * Used by the default LayoutManager class - SpinnerLayout for missing (null) editor/nextButton/previousButton
     * children.
     */
     ...
     * <code>previousButton</code> children of the JSpinner. These three children must be added with a constraint that
     * identifies their role: "Editor", "Next", and "Previous". The default layout manager can handle the absence of any
     * of these children.
     * 
