...
public class AluminiumLookAndFeel extends AbstractLookAndFeel {
    ...
    protected void initClassDefaults(UIDefaults table) {
        ...
        Object[] uiDefaults = {
                ...
                BaseScrollBarUI.class.getName(), "FileChooserUI", BaseFileChooserUI.class.getName(),
                "MenuUI",
                ...
                AluminiumRadioButtonUI.class.getName(), "ButtonUI", AluminiumButtonUI.class.getName(),
                "ToggleButtonUI", AluminiumToggleButtonUI.class.getName(), "SliderUI",
                AluminiumSliderUI.class.getName(), "PanelUI", AluminiumPanelUI.class.getName(), "ScrollPaneUI",
                AluminiumScrollPaneUI.class.getName(), "TabbedPaneUI", AluminiumTabbedPaneUI.class.getName(),
                "SplitPaneUI", AluminiumSplitPaneUI.class.getName(), "ToolBarUI", AluminiumToolBarUI.class.getName(),
                "MenuBarUI", AluminiumMenuBarUI.class.getName(), "PopupMenuSeparatorUI",
                AluminiumPopupMenuSeparatorUI.class.getName(), "InternalFrameUI",
