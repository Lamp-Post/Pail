...
public class HiFiButtonUI extends BaseButtonUI {
    ...
    protected void paintText(Graphics g, AbstractButton b, Rectangle textRect) {
        ...
        JTattooUtilities.drawStringUnderlineCharAt(b, g, b.getText(), mnemIndex, textRect.x + offs + 1, textRect.y
                + offs + fm.getAscent() + 1);
        g2D.setComposite(composite);
        g2D.setColor(fc);
        JTattooUtilities.drawStringUnderlineCharAt(b, g, b.getText(), mnemIndex, textRect.x + offs, textRect.y + offs
                + fm.getAscent());
    }
}
