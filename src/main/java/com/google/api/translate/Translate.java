...
public final class Translate extends GoogleAPI {
     ...
     * 
     * @param text
     *            The array of Strings to translate.
     * @param from
     *            The language code to translate from.
     * @param to
     *            The language code to translate to.
     ...
     *            The array of Strings to translate.
     * @param from
     *            The array of Language codes to translate from.
     * @param to
    ...
    public static String[] execute(final String[] text, final Language from[], final Language[] to) throws Exception {
        ...
        parametersBuilder.append(PARAMETERS.replaceAll("#FROM#", from[0].toString()).replaceAll("#TO#",
                to[0].toString()));
